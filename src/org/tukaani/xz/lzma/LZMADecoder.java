...
public final class LZMADecoder extends LZMACoder {
    ...
    public boolean equals(Object o) {
        ...
        LZMADecoder that = (LZMADecoder) o;
        return lz.equals(that.lz) && rc.equals(that.rc) && literalDecoder.equals(that.literalDecoder) && matchLenDecoder.equals(that.matchLenDecoder) && repLenDecoder.equals(that.repLenDecoder);
    }

    @Override
    public int hashCode() {
        return Objects.hash(lz, rc, literalDecoder, matchLenDecoder, repLenDecoder);
    }
    ...
    private class LiteralDecoder extends LiteralCoder {
        ...
        void reset() {
            for (LiteralSubdecoder subdecoder : subdecoders) {
                subdecoder.reset();
            }
        }
